...
class SubscriptionPlans extends StatelessWidget {
  final List<Subscription> subscriptions = [
    Subscription("Silver", "5 USD/month", "50 USD/year", "Enhanced features", "1 month", 10),
    Subscription("Gold", "10 USD/month", "100 USD/year", "Premium access to all features", "3 months", 15),
    Subscription("Platinum", "15 USD/month", "150 USD/year", "Exclusive benefits", "6 months", 20),
  ];
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Subscribe', style: TextStyle(color: Colors.white, fontSize: 20)),
              ),
              const SizedBox(height: 16.0),
              ElevatedButton(
                onPressed: () {
